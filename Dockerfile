...
RUN cd /usr/local/docker-tutorial && mvn package
...
CMD ["java", "-cp", "/usr/local/docker-tutorial/target/com.mpo.docker-1.0-SNAPSHOT.jar", "com.mpo.docker.HelloWorldPing"]